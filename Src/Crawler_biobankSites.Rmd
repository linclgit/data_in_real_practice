...
tw <- map_data("world")[which(map_data("world")$region == "Taiwan"),]
ggplot() + 
  geom_polygon(data = tw, aes(x=long, y = lat, group = group), fill="grey") +   
  #coord_fixed(1.3)+
  theme_nothing()+
  geom_point(data = stations, aes(x = long, y = lat), color = "black") 
```
